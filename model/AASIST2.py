...
class SSLFrontend(nn.Module):
    def __init__(self, model_label, model_dim):
        ...
        if model_label == "xlsr":
            ...
            task = AudioPretrainingTask.setup_task(args, target_dictionary=Dictionary())
            model = Wav2Vec2Model.build_model(cfg=Wav2Vec2Config())
