...
from utils import pad_random


class ASVspoof2019(Dataset):
    def __init__(self, ids, dir_path, labels, is_train=True):
        self.ids = ids
        self.labels = labels
    ...
    def __getitem__(self, index):
        ...
        x_pad = pad_random(audio, self.cut)
        x_inp = Tensor(x_pad)
...
def get_datasets(config):
    ...
    eval_dataset = ASVspoof2019(eval_ids, config["eval_path_flac"], eval_labels)
